...
//		System.out.println(count);
	...
	public void UnitVisibility() throws InterruptedException {
		...
		driver.switchTo().frame("SkyTrac_Controls_Window_InnerFrame_397");
	...
	public void Unitdisplay() throws InterruptedException {
		...
		driver.switchTo().frame("SkyTrac_Controls_Window_InnerFrame_398");
//driver.findElement(By.xpath("//*[@id=\"RadTabStrip1_ctl00]/span/span")).click(); //*[@id="RadTabStrip1_ctl00"]/span/span
		Select sc = new Select(driver.findElement(By.id("Icon-Size-Select")));
		sc.selectByIndex(2);
		driver.findElement(By.id("Button5")).click();
		driver.findElement(By.id("Button1")).click();
		driver.switchTo().defaultContent();
