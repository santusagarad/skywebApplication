...
public class Admin {
	...
	String driverPath = "C:\\Users\\Roy\\Downloads\\administration-master\\SkywebApplication\\Drivers\\chromedriver.exe";
	...
	public void Georeference(String Name,String Ident,String Region,String LatitudeText1,String LongitudeText1) throws InterruptedException {
		...
		driver.switchTo().defaultContent();
		Thread.sleep(8000);
		WebElement element4 = driver.findElement(By.xpath("//*[@id=\"RadMenubar_m3\"]/span")); //*[@id="RadMenubar_m3"]/span
		Thread.sleep(2000);
	...
	public void DVITextMessages() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement radioDVI = driver.findElement(By.id("ctl00_MainContentPlaceHolder_DviTextMessagesMain_ManageMessageGroups_dviMessageGroupRadGrid_ctl00_ctl04_selectDviMsgGroup"));
		radioDVI.click();
		Thread.sleep(2000);
	...
	public void DVIPhonenumber() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.id("ctl00_MainContentPlaceHolder_DviPhoneNumbersMain_AddPhoneGroup_dviPhoneNameTextBox_text")).clear();
		...
		Actions actionDVIPH =new Actions(driver);
		actionDVIPH.sendKeys(Keys.PAGE_DOWN).build().perform();
		Thread.sleep(2000);
		...
		alertDVIph.accept();	
		Thread.sleep(5000);
		WebElement radioDVIph = driver.findElement(By.id("ctl00_MainContentPlaceHolder_DviPhoneNumbersMain_ManagePhoneGroups_dviPhoneGroupRadGrid_ctl00_ctl04_selectDviPhoneGroup"));
		radioDVIph.click();
		Thread.sleep(5000);
	...
	public void Overdue() throws InterruptedException {
		...
		Thread.sleep(4000);
		driver.findElement(By.id("ctl00_MainContentPlaceHolder_OverdueNotificationManager_AddOrEditNotificationSetting_IdLabelTextBox")).clear();
		driver.findElement(By.id("ctl00_MainContentPlaceHolder_OverdueNotificationManager_AddOrEditNotificationSetting_IdLabelTextBox")).sendKeys("ID1");
		Actions actionovr = new Actions(driver);
		actionovr.sendKeys(Keys.PAGE_DOWN).build().perform();
		Thread.sleep(2000);
